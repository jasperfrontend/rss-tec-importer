...
SNIPPET;
	...
	private static function maybe_render_debug_log(): void {
		...
		<div style="margin: 20px 0;">
			<h2 style="margin-bottom: 8px;">🪲 <?php esc_html_e( 'Import Debug Log', 'rss-tec-importer' ); ?></h2>
			<p style="margin-top: 0; color: #666;"><?php esc_html_e( 'Generated by the last manual import. Disappears on next page load.', 'rss-tec-importer' ); ?></p>
			<div style="
